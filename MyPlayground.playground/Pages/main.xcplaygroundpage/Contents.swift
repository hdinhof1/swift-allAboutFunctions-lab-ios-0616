 ...
 */
func displayFavCharacter(favoriteCharacter: String) {
    print ("My favorite character is \(favoriteCharacter).")
}
 ...
 */
let favoriteCharacter = "Tyrion Lannister"
displayFavCharacter(favoriteCharacter)
//favoriteCharacter = "Ygritte"
 ...
 */
// write your code here
func bandRank(a bandName: String, number: Int) {
    print("My \(number) favorite band is \(bandName).")
}
bandRank(a: "Decemberists", number: 1)
...
madLib("infinity", preposition: "by", characterName: "Woody")
 ...
 */
func buzzPhrase(characterName: String) -> String {
    let uppercaseName = characterName.uppercaseString
    return "To infinity and beyond, \(uppercaseName)!"
}
print (buzzPhrase("Tyrion"))
